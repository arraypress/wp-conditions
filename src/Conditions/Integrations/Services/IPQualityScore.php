	...
	private static function get_detection_conditions(): array {
		return [
			'ipqs_is_proxy'       => [
				...
				'group'         => __( 'IPQualityScore: Detection', 'arraypress' ),
				'type'          => 'boolean',
	...
	private static function get_risk_conditions(): array {
		return [
			'ipqs_fraud_score'  => [
				...
				'group'         => __( 'IPQualityScore: Risk', 'arraypress' ),
				'type'          => 'number',
	...
	private static function get_location_conditions(): array {
		return [
			'ipqs_country' => [
				...
				'group'         => __( 'IPQualityScore: Location', 'arraypress' ),
				'type'          => 'select',
				'multiple'      => true,
	...
	private static function get_email_conditions(): array {
		return [
			'ipqs_is_disposable_email' => [
				...
				'group'         => __( 'IPQualityScore: Email', 'arraypress' ),
				'type'          => 'boolean',
