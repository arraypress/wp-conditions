...
class Attributes {
	...
	public static function get_sizes(): array {
		return [
			[
				'value' => 'xs',
				'label' => __( 'Extra Small (XS)', 'arraypress' ),
			],
			[
				'value' => 's',
				'label' => __( 'Small (S)', 'arraypress' ),
			],
			[
				'value' => 'm',
				'label' => __( 'Medium (M)', 'arraypress' ),
			],
			[
				'value' => 'l',
				'label' => __( 'Large (L)', 'arraypress' ),
			],
			[
				'value' => 'xl',
				'label' => __( 'Extra Large (XL)', 'arraypress' ),
			],
		];
	}
	...
	public static function get_sizes_extended(): array {
		return [
			[
				'value' => 'xxs',
				'label' => __( 'Extra Extra Small (XXS)', 'arraypress' ),
			],
			[
				'value' => 'xs',
				'label' => __( 'Extra Small (XS)', 'arraypress' ),
			...
			[
				'value' => 'xxl',
				'label' => __( 'Extra Extra Large (XXL)', 'arraypress' ),
			],
			[
				'value' => 'xxxl',
				'label' => __( 'Extra Extra Extra Large (XXXL)', 'arraypress' ),
			],
		];
	}
	...
	public static function get_conditions(): array {
		return [
			[
				'value' => 'new',
				'label' => __( 'New', 'arraypress' ),
			],
			[
				'value' => 'like_new',
				'label' => __( 'Like New', 'arraypress' ),
			],
			[
				'value' => 'refurbished',
				'label' => __( 'Refurbished', 'arraypress' ),
			],
			[
				'value' => 'used',
				'label' => __( 'Used', 'arraypress' ),
			],
		];
	}
}
